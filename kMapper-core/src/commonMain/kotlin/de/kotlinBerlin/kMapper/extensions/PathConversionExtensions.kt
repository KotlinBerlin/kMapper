...
fun <S, V, V1> KMutableProperty1<S, V>.readConverted(convert: (V) -> V1): ReadWritePath<S, V1, V> = path.readConverted(convert)

fun <S, V, V1> ((S) -> V).readConverted(convert: (V) -> V1): ReadPath<S, V1> = path.readConverted(convert)
...
fun <S, V, V1> KMutableProperty1<S, V>.readConverted(mapping: Mapping<V, V1>): ReadWritePath<S, V1, V> = path.readConverted(mapping)

fun <S, V, V1> ((S) -> V).readConverted(mapping: Mapping<V, V1>): ReadPath<S, V1> = path.readConverted(mapping)
...
fun <S, V, V1> KMutableProperty1<S, V>.writeConverted(convert: (V1) -> V): ReadWritePath<S, V, V1> = path.writeConverted(convert)

fun <S, V, V1> ((S, V) -> Unit).writeConverted(convert: (V1) -> V): WritePath<S, V1> = path.writeConverted(convert)
...
fun <S, V, V1> KMutableProperty1<S, V>.writeConverted(mapping: Mapping<V1, V>): ReadWritePath<S, V, V1> = path.writeConverted(mapping)

fun <S, V, V1> ((S, V) -> Unit).writeConverted(mapping: Mapping<V1, V>): WritePath<S, V1> = path.writeConverted(mapping)
